...
%\FloatBarrier
\begin{figure}[h!]
\centerline{\resizebox{0.3\linewidth}{!}{\includegraphics{figure2}}}
...
\begin{figure}[h!]
\hfill
\subfigure[]{\includegraphics[scale=0.7]{figure3}\label{fig:crash}}
\hfill
...
%\begin{figure}[t]
%\centerline{\resizebox{0.8\linewidth}{!}{\includegraphics{camera}}}
%\caption{Distributiont of Exceptions for \texttt{CAMERA} permission.}
%\label{fig:camera}
%\end{figure}

%\begin{figure}[t]
%\centerline{\resizebox{0.8\linewidth}{!}{\includegraphics{audio}}}
